...
import {NetFlixBackgroundImage, ProfilePicture } from '../utils/constants';
const Login = () => {
...
updateProfile(auth.currentUser, {
    displayName: name.current.value,photoURL:ProfilePicture
}).then(() => {
...
const ButtonSignupform =()=>{
    ...
    <div>
        ...
        <div className='absolute'>
            <img className='w-screen h-screen object-cover' src={NetFlixBackgroundImage} alt="background" />
            <div className='absolute top-1/4 bottom-1/4 m-auto right-0 left-0 w-3/4 sm:w-1/4'>
